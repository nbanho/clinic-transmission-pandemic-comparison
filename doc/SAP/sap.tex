...
Our hypothesized links between pandemic-related infection control measures and the number of \emph{Mtb} particles in the air are illustrated with a direct acyclic graph (DAG) model (\Cref{fig:dag}). In the following, we develop our research hypotheses about the effects of infection control measures on the number of \emph{Mtb} particles in the air. 
